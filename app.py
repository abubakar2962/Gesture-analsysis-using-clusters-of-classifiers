...
def train(feature_group=1):
    ...
    if name_predicts == "A":
        train_videos, X_train, y_train = load_features_dataset("Extracted_Features/train_features1.json")
        train_videos, X_train, y_train = group_features(train_videos, X_train, y_train,feature_group)
        test_videos, X_test, y_test = load_features_dataset("Extracted_Features/test_features1.json")
        test_videos, X_test, y_test = group_features(test_videos, X_test, y_test,feature_group)
    elif name_predicts == "B":
        train_videos, X_train, y_train = load_features_dataset("Extracted_Features/train_features2.json")
        train_videos, X_train, y_train = group_features(train_videos, X_train, y_train,feature_group)
        test_videos, X_test, y_test = load_features_dataset("Extracted_Features/test_features2.json")
        test_videos, X_test, y_test = group_features(test_videos, X_test, y_test,feature_group)
    elif name_predicts == "c":
        train_videos, X_train, y_train = load_features_dataset("Extracted_Features/train_features3.json")
        train_videos, X_train, y_train = group_features(train_videos, X_train, y_train,feature_group)
        test_videos, X_test, y_test = load_features_dataset("Extracted_Features/test_features3.json")
        test_videos, X_test, y_test = group_features(test_videos, X_test, y_test,feature_group)
    elif name_predicts == "D":
        train_videos, X_train, y_train = load_features_dataset("Extracted_Features/train_features4.json")
        train_videos, X_train, y_train = group_features(train_videos, X_train, y_train,feature_group)
        test_videos, X_test, y_test = load_features_dataset("Extracted_Features/test_features4.json")
        test_videos, X_test, y_test = group_features(test_videos, X_test, y_test,feature_group)
    elif name_predicts == "E":
        train_videos, X_train, y_train = load_features_dataset("Extracted_Features/train_features5.json")
        train_videos, X_train, y_train = group_features(train_videos, X_train, y_train,feature_group)
        test_videos, X_test, y_test = load_features_dataset("Extracted_Features/test_features5.json")
        test_videos, X_test, y_test = group_features(test_videos, X_test, y_test,feature_group)
    elif name_predicts == "F":
        train_videos, X_train, y_train = load_features_dataset("Extracted_Features/train_features6.json")
        train_videos, X_train, y_train = group_features(train_videos, X_train, y_train,feature_group)
        test_videos, X_test, y_test = load_features_dataset("Extracted_Features/test_features6.json")
        test_videos, X_test, y_test = group_features(test_videos, X_test, y_test,feature_group)

    trainKNN(X_train, X_test, y_train, y_test, 1)

    if feature_group == 1:
        print("--------Trained with 25% Features---------")
    elif feature_group == 2:
        print("--------Trained with 50% Features---------")
    elif feature_group == 3:
        print("--------Trained with 75% Features---------")
