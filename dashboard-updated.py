...
"")
        ...
        # clear text on button click
        self.startButton.clicked.connect(self.start_commands)
        ...
        self.label_cluster_predicted_result.setGeometry(QtCore.QRect(750, 70, 261, 21))
        ...
        self.label_word_true_result.setGeometry(QtCore.QRect(450, 120, 281, 21))
        ...
        self.label_word_predicted_result.setGeometry(QtCore.QRect(750, 120, 281, 21))
    ...
    def openFile(self,MainWindow):
        fileName = tuple(QtWidgets.QFileDialog.getOpenFileName(None,"Select File", "","MOV FIles(*.mov);;AVI Files (*.avi);; MP4 FIles(*.mp4)"))
        ...
        for element in file_path:
            if element == "/":
                count = count + 1
            if count >= 2 :
                actualPath = actualPath + element
        actualPath = "." + actualPath
        self.video_text_box.setText(actualPath)
        f = open("input.txt", "w")
        f.write(actualPath)
        f.write("\n")
        print("Video File location is ",actualPath)
        f.close()
        
    
    # clear button function
    def clear_fields(self,MainWindow):
        _translate = QtCore.QCoreApplication.translate
        self.video_text_box.setText("")
        self.label_cluster_predicted_result.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">None</span></p><p align=\"center\"><br/></p></body></html>"))
        self.label_word_true_result.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">None</span></p><p align=\"center\"><br/></p></body></html>"))
        self.label_word_predicted_result.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">None</span></p><p align=\"center\"><br/></p></body></html>"))
    ...
    # start command button function
    def start_commands(self,MainWindow):
        
        if self.video_text_box.toPlainText() == "":
            print("-------Warning---------")
            print("-------Video Input text box is empty---------")
            return
        
        _translate = QtCore.QCoreApplication.translate
        #subprocess.check_output("start /wait cmd /k  {.\env\Scripts\activate}", shell=True)
        os.system('.\env\Scripts\activate')

        if self.radioButton_25.isChecked() == True:
            os.system('python main.py  --train_with_features 1')
            os.system('python main.py  --train_with_features 1 --input input_videos --predict True --no_cuda --input input.txt')
        elif self.radioButton_50.isChecked() == True:
            os.system('python main.py  --train_with_features 2')
            os.system('python main.py  --train_with_features 2 --input input_videos --predict True --no_cuda --input input.txt')
        elif self.radioButton_75.isChecked() == True:
            os.system('python main.py  --train_with_features 3')
            os.system('python main.py  --train_with_features 3 --input input_videos --predict True --no_cuda --input input.txt')
        
        # Reading csv prediction file
        with open('./Output/predictions.csv', newline='') as csvfile:
            data = csv.DictReader(csvfile)
            print("---------------------------------")
            for row in data:
                print(row['truth'], row['predictions'],row['clusters'])
                self.label_cluster_predicted_result.setText(_translate("<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">'",row['clusters'],"'</span></p><p align=\"center\"><br/></p></body></html>"))
                self.label_word_true_result.setText(_translate("<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">'",row['truth'],"'</span></p><p align=\"center\"><br/></p></body></html>"))
                self.label_word_predicted_result.setText(_translate("<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">'",row['predictions'],"'</span></p><p align=\"center\"><br/></p></body></html>"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.startButton_2.setText(_translate("MainWindow", "Load Video"))
        self.clear_button.setText(_translate("MainWindow", "Clear"))
        self.groupBox_3.setTitle(_translate("MainWindow", "Frames Percentage"))
        self.startButton.setText(_translate("MainWindow", "Analyze"))
...
""))
        ...
        self.label_cluster_predicted_result.setText(_translate( "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">'",default,"'</span></p><p align=\"center\"><br/></p></body></html>"))
        self.label_word_true_result.setText(_translate( "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">,'",default,"',</span><br/></p><p>410 70 281 21 &lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;&lt;span style=&quot; font-size:10pt; font-weight:600;&quot;&gt;Cluster&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;&lt;/body&gt;&lt;/html&gt; 410 70 281 21 &lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;&lt;span style=&quot; font-size:10pt; font-weight:600;&quot;&gt;Cluster&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;&lt;/body&gt;&lt;/html&gt; esources/&gt; </p></body></html>"))
        self.label_word_predicted_result.setText(_translate( "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">'",default,"'</span><br/></p><p>410 70 281 21 &lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;&lt;span style=&quot; font-size:10pt; font-weight:600;&quot;&gt;Cluster&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;&lt;/body&gt;&lt;/html&gt; 410 70 281 21 &lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;&lt;span style=&quot; font-size:10pt; font-weight:600;&quot;&gt;Cluster&lt;/span&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;&lt;/body&gt;&lt;/html&gt; esources/&gt; </p></body></html>"))
